...
public class LoggingNewsAppsData {
	...
	private class HttpAsyncTask extends AsyncTask<String, Void, String> {
		...
		protected String doInBackground(String... urls) {
			...
			try {
				jsonObject.accumulate("userActivity",
						runningNewsApps.getUserActivity() + "");
			} catch (JSONException e) {
				// TODO Auto-generated catch block
				e.printStackTrace();
			}
			...
			try {
				jsonObject.accumulate("userActivityConfidenceLevel",
						runningNewsApps.getUserActivityConfidence() + "");
			} catch (JSONException e) {
				// TODO Auto-generated catch block
				e.printStackTrace();
			}
