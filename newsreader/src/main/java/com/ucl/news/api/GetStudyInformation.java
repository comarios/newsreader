...
public class GetStudyInformation {
	...
	public GetStudyInformation(Context con, MainActivity start, long user_id) {
		context = con;
		this.start = start;
		...
		task.execute(Constants.SERVER + Constants.STUDY_API + Constants.GET_StudyInformation);
	}
	...
	private class HttpAsyncTask extends AsyncTask<String, Void, String> {
		...
		protected void onPostExecute(String result) {
			...
			result2 = result;
			try {
				mainActivity.getStudyInformation(result);
			} catch (Exception e) {
				// TODO Auto-generated catch block
				e.printStackTrace();
			}
